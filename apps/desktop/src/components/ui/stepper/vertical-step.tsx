...
interface VerticalStepProps extends StepSharedProps {
  children?: ReactNode;
}
...
const verticalStep = forwardRef<HTMLDivElement, VerticalStepProps>(
  ...
  (props, reference) => {
    ...
    function renderChildren() {
      if (expandVerticalSteps === undefined || !expandVerticalSteps) {
        return (
    ...
    return (
      ...
      >
        ...
        <div
          ...
          ref={(node) => {
            if (scrollTracking !== undefined && scrollTracking) {
              node?.scrollIntoView({
                behavior: "smooth",
                block: "center",
              });
...
export { verticalStep as VerticalStep };
